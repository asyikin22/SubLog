...
const ExpensesPage = ({
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 space-y-6">
      {/* Statistics Cards - Monthly Total wider than others */}
      <div className="flex gap-4">
        <div className="bg-white rounded-lg px-4 py-2 shadow-sm border border-gray-100">
          <div className="text-center">
            <p className="text-xs text-gray-600 mb-1">Total Due</p>
            <p className="text-xl font-bold text-gray-700">
              {balanceVisible ? expenses.length : expenses.length}
            </p>
          </div>
        </div>
        <div className="bg-white rounded-lg px-4 py-2 shadow-sm border border-gray-100">
          <div className="text-center">
            ...
            <p className="text-xl font-bold text-orange-600">
              {balanceVisible ? upcomingExpenses.length : upcomingExpenses.length}
            </p>
          </div>
        </div>
