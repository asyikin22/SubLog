// components/modals/DeleteWishlistModal.jsx
...
const DeleteWishlistModal = ({
  ...
  if (!showDeleteConfirm || !wishlistToDelete) return null;
    ...
    <div className="fixed inset-0 bg-white bg-opacity-20 z-50 flex items-center justify-center p-4" style={{backdropFilter: 'blur(8px)', backgroundColor: 'rgba(0,0,0,0.6)'}}>
      <div className="bg-white rounded-2xl w-full md:max-w-md">
        <div className="p-6 text-center">
          ...
          <h3 className="text-lg font-semibold text-gray-800 mb-2">Delete Wishlist Item?</h3>
          <p className="text-gray-600 mb-4">
            Are you sure you want to delete <strong>{wishlistToDelete.itemName}</strong>? 
